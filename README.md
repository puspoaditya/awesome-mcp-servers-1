...
- <img src="https://cdn.simpleicons.org/cloudflare/F38020" height="14"/> [Cloudflare](https://github.com/cloudflare/mcp-server-cloudflare)
- <img src="https://cdn.simpleicons.org/cloudflare/F38020" height="14"/> [Cloudflare Workers AI](https://github.com/puspoaditya/cloudflare-workers-ai-mcp) - Cloudflare Workers AI inference for AI agents — LLM chat completions (Llama 3.3 70B, Llama 3.1 8B, Llama 4 Scout, Qwen Coder 32B, DeepSeek R1 Distill), text embeddings (BGE), and image generation (Flux 1 Schnell). Free tier, TypeScript, stdio, verified live.
